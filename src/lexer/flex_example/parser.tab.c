...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MAP = 3,                        /* MAP  */
  YYSYMBOL_ROOM = 4,                       /* ROOM  */
  YYSYMBOL_CONNECT = 5,                    /* CONNECT  */
  ...
  YYSYMBOL_BICONNECT = 12,                 /* BICONNECT  */
  ...
  YYSYMBOL_map_decl = 35,                  /* map_decl  */
  YYSYMBOL_map_body = 36,                  /* map_body  */
  YYSYMBOL_stmt = 37,                      /* stmt  */
  YYSYMBOL_room_decl = 38,                 /* room_decl  */
  YYSYMBOL_connect_decl = 39               /* connect_decl  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "MAP", "ROOM",
  "CONNECT", "LIST", "STRING_TYPE", "BOOL_TYPE", "IDENTIFIER", "INT_TYPE",
  "ARROW", "BICONNECT", "LARROW", "EQ", "NE", "AND", "OR", "GE", "LE",
  "GT", "LT", "PLUS", "MINUS", "MULT", "DIV", "INT_LITERAL",
  "STRING_LITERAL", "SEMICOLON", "LBRACE", "RBRACE", "LPAREN", "RPAREN",
  "$accept", "program", "map_decl", "map_body", "stmt", "room_decl",
  "connect_decl", YY_NULLPTR
};
...
{
      -1,    -6,     4,   -25,   -24,   -25,   -25,    -4,   -21,   -20,
     -25,   -25,   -25,   -25,   -19,    -3,   -25,   -17,   -16,   -25
};
...
{
       0,     3,    34,    35,     9,     0,    29,    36,     4,     5,
      30,    37,    38,    39,    27,    27,    28,    11,    27,    28
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 8: /* room_decl: ROOM STRING_LITERAL SEMICOLON  */
#line 59 "parser.y"
                                  {
...
#line 1109 "parser.tab.c"
  ...
  case 9: /* connect_decl: CONNECT STRING_LITERAL ARROW STRING_LITERAL SEMICOLON  */
#line 67 "parser.y"
                                                          {
