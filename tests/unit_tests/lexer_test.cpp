...
TEST(UnitTestToken, InvalidInteger) {
...
TEST(UnitTestToken, InvalidString) {
...
TEST(UnitTestToken, InvalidFloat) {
...
TEST(UnitTestToken, InvalidIdentifier) {
